...
#                 t[i][j] = t[i-1][j - nums[i-1]] or t[i-1][n]
...
#     return subset_sum(nums, sum(nums)//2)
...
#     temp = subset_sum_modified(nums, sum(nums))
#     temp2 = []
...
#     else:
#         t[n][m] = max(lcs_recursive(x, y, n, m-1), lcs_recursive(x, y, n-1, m))
#         return t[n][m]
